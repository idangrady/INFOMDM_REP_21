...
def information_gain(y,X_colm,split_tresh):
    ...
    return parent_ent - (
        weight_left * gimi_indx(left_child)
        + weight_right * (gimi_indx(right_child))
    )
